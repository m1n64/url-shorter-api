...
func (c *linkServiceClient) GenerateSlug(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GenerateSlugResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateSlugResponse)
	err := c.cc.Invoke(ctx, LinkService_GenerateSlug_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLinkServiceServer) GenerateSlug(context.Context, *Empty) (*GenerateSlugResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateSlug not implemented")
}
...
func _LinkService_GenerateSlug_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LinkServiceServer).GenerateSlug(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LinkService_GenerateSlug_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LinkServiceServer).GenerateSlug(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LinkService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GenerateSlug",
			Handler:    _LinkService_GenerateSlug_Handler,
		},
	},
